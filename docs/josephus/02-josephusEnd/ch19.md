...
19. Igitur Vespasianus ultro[^1] se existimans[^2] longitudine temporis hostiumque incursibus obsideri, cum prope[^3] iam muris aggeres[^4] aequarentur, arietem[^5] admovere decrevit.
...
[^2]: *Existimans*: starts off **indirect statement**

[^3]: _Prope_: take this as just an adverb meaning *nearly*, not the preposition

[^4]: *Aggeres:* the famous mud ramp wall thing we’ve seen a lot in sieges

[^5]: *Arietem: an aries, \-etis (m)* is a [battering ram](https://en.wikipedia.org/wiki/Battering_ram), a common tool in siege warfare
